			...
			for (c = 0; c < leftImg->height; ++c)
			{
				for (r = 0; r < leftImg->width; ++r)
				{
					if ((r - (disparity_img_M_R[c*width + r] * (9 - n) / 10)) > 0){
						R_Channel_Re->imageData[c * leftImg->width + r - (disparity_img_M_R[c*width + r] * (9 - n) / 10)] = R_Channel_mi->imageData[c * leftImg->width + r];
						G_Channel_Re->imageData[c * leftImg->width + r - (disparity_img_M_R[c*width + r] * (9 - n) / 10)] = G_Channel_mi->imageData[c * leftImg->width + r];
						B_Channel_Re->imageData[c * leftImg->width + r - (disparity_img_M_R[c*width + r] * (9 - n) / 10)] = B_Channel_mi->imageData[c * leftImg->width + r];
					}
					else{//이론적으로 여기는 채울수가 없다. 젠장 
						if (c > 0){
							R_Channel_Re->imageData[c * leftImg->width + r - (disparity_img_L_M[c*width + r] * (9 - n) / 10)] = R_Channel_mi->imageData[(c - 1) * leftImg->width + width + (disparity_img_M_R[c*width + r] * (9 - n) / 10)];
							G_Channel_Re->imageData[c * leftImg->width + r - (disparity_img_L_M[c*width + r] * (9 - n) / 10)] = 0;// G_Channel_mi->imageData[(c - 1) * leftImg->width + width + (disparity_img_M_R[c*width + r] * (9 - n) / 10)];
							B_Channel_Re->imageData[c * leftImg->width + r - (disparity_img_L_M[c*width + r] * (9 - n) / 10)] = B_Channel_mi->imageData[(c - 1) * leftImg->width + width + (disparity_img_M_R[c*width + r] * (9 - n) / 10)];
						}
					}
				}
			}
			...
			for (c = 0; c < leftImg->height; ++c)
			{
				for (r = 0; r < leftImg->width; ++r)
				{
					if ((r - (disparity_img_L_M[c*width + r] * (9 - n) / 10)) > 0){
						...
						if (c > 0){
							R_Channel_Re->imageData[c * leftImg->width + r - (disparity_img_L_M[c*width + r] * (9 - n) / 10)] = R_Channel_mi->imageData[(c - 1) * leftImg->width + width + (disparity_img_M_R[c*width + r] * (9 - n) / 10)];
							G_Channel_Re->imageData[c * leftImg->width + r - (disparity_img_L_M[c*width + r] * (9 - n) / 10)] = G_Channel_mi->imageData[(c - 1) * leftImg->width + width + (disparity_img_M_R[c*width + r] * (9 - n) / 10)];
